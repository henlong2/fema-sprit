document.addEventListener('DOMContentLoaded', () => {
    ...
    function showRandomMessage() {
        ...
        actionButton.textContent = '정화의 카드 찾기 시작'; // Changed text
    ...
    function endGame(isWin) {
        ...
        if (isWin) {
            ...
            gameMessage.textContent = `아쉽게도 특별한 카드를 찾지 못했습니다.`; // Modified message
    ...
    restartButton.addEventListener('click', () => {
        ...
        actionButton.classList.remove('red-button');
